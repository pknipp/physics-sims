  ...
  render() {
    ...
    return (
      <form onSubmit={this.handleSubmit}>
        <input type="text" value={username} onChange={this.updateUsername} placeholder='Username' />
        <input type="email" value={email} onChange={this.updateEmail} placeholder='Email' />
        <input type="password" value={password} onChange={this.updatePassword} placeholder='Password' />
        <input type="password" value={password2} onChange={this.updatePassword2} placeholder='Matching Password' />
...
const msp = ({auth}) => ({loggedIn: !!auth.id});
